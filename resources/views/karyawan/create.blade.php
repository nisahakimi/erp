    ...
    <div class="card-body">
        ...
        <form action="{{ route('karyawans.store') }}" method="POST">
            ...
            <div class="position-relative row form-group"><label for="nama" class="col-sm-2 col-form-label">Nama
                ...
                <div class="col-sm-10">
                    <input name="nama" id="nama" placeholder="Nama Karyawan" type="text" class="form-control @error('nama') is-invalid @enderror " value="{{ old('nama')}}">
                    @error('nama')
            ...
            <div class="position-relative row form-group"><label for="notelp" class="col-sm-2 col-form-label">No.HP
                ...
                <div class="col-sm-10">
                    <input name="notelp" id="notelp" placeholder="No.HP Karyawan" type="text" class="form-control @error('notelp') is-invalid @enderror"  value="{{ old('notelp')}}">
                </div>
                @error('notelp')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="position-relative row form-group"><label for="email" class="col-sm-2 col-form-label">Email</label>
                <div class="col-sm-10">
                    <input type="text" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email Karyawan"  value="{{old('email')}}">
                </div>
                @error('email')
                    <div class="text-danger">{{$message}}</div>
                @enderror
